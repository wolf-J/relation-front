  ...
  <div class="page">
    <Card class="search-con" dis-hover>
      ...
      >
        ...
        <FormItem>
          <template #label>
            <div class="label">预审编号</div>
          </template>
          <Input v-model="formObj.preApplyNo" size="large" clearable />
        </FormItem>
...
import { pre_apply_progress_query_url, queryByPage } from "@/api/data";
import { config, preApplyTableColumns } from "./common.js";
...
export default {
  ...
  data() {
    return {
      ...
      tableData: [],
      tableColumns: preApplyTableColumns,
      pageSize: 10,
      total: 0,
      page: 1,
      validateRules: {
